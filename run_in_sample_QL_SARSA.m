function [results, optimal_policies] = run_in_sample_QL_SARSA(combinations, w0, G, T, nw, np, mu_vals, sig_vals, alpha, seed)
    ...
    for i = 1:size(combinations, 1)
        ...
        [suc_rl, Q_rl, op_rl] = TEC_QL_GBWM_solve_QL_CANEVAS_SARSA(w0, G, T, nw, np, mu_vals, sig_vals, epochs, epsilon, alpha, seed);
        results = [results; epsilon, epochs, suc_rl];
